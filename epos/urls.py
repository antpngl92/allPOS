...
urlpatterns = [
    ...
    path('transactions/', inventory_transactions_view, name="inventory ingredients transactions"),
    ...
    path('update-ingredient/<int:pk>',ingredient_update_API, name="upgrade ingredient"),
    path('create-ingredient/',ingredient_create_API, name="create ingredient2"),
    path('delete-ingredient/<int:pk>',ingredient_delete_API, name="delete ingredient2"),
    path('product-ingredients',get_ingredients_for_products_API, name="get products ingredients"),
    path('product-update/<int:pk>',update_product_API, name="update product"),
    path('product-create/>',create_product_API, name="create product"),
    path('product-delete/<int:pk>',delete_product_API, name="delete product"),
    path('automated-ordering-settings',get_automated_ordering_settings_API, name="automated ordering"),
    path('automated-ordering-update-settings',update_autmated_ordering_settings_API, name="update automated ordering"),
]