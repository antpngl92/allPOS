    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hourly_pay_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=5)),
                ('start_date', models.DateField(blank=True)),
                ('end_date', models.DateField(blank=True)),
                ('is_employeed', models.BooleanField(blank=True)),
                ('nin', models.CharField(blank=True, max_length=9, unique=True)),
